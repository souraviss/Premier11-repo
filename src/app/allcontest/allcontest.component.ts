...
@Component({
  selector: 'app-allcontest',
  templateUrl: './allcontest.component.html',
  styleUrls: ['./allcontest.component.scss']
})
export class AllcontestComponent implements OnInit {
  ...
  constructor(  private rest: ServicesService , private _route : ActivatedRoute , private router: Router) { }
  ...
  allContestPage(){
    alert('hello');
    this.router.navigate(['/allcontest']);
     }
